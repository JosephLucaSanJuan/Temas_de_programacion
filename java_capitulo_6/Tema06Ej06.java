...
public class Tema06Ej06 {
  public static void main(String[] args) {
    ...
    System.out.println("Adivina un número. Tienes 5 intentos.");
    ...
    while (intentos>=0) {
      ...
      if (numInt==n) {
        ...
        System.out.println("Intenta un número más grande. Te quedan "+intentos+" intentos.");
      } else if (numInt>n) {
        System.out.println("Intenta un número más pequeño. Te quedan "+intentos+" intentos");
      }
